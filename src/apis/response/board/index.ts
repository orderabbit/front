...
import IncreaseViewCountResponseDto from "./increase-board-view-count.response.dto";
...
import GetTop3BoardResponseDto from "./get-top-3-board-list.response.dto";
