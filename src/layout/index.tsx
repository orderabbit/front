...
export default function Header() {
  ...
  useEffect(() => {
    ...
    const isDetailPage = pathname.startsWith(DETAIL_PATH(''));
  ...
  const UploadButton = () => {
    ...
    const onUploadButtonClickHandler = async () => {
      ...
      const isWriterPage = pathname === BOARD_PATH() + '/' + WRITE_PATH();
      if(isWriterPage) {
      ...
      patchBoardRequest(itemNumber, requestBody, accessToken
    ...
    <div id='header'>
      <div className='header-container'>
        ...
        <div className='header-right-box'>
          ...
          {!(isAuthPage || isMainPage || isUserPage) && <UploadButton />}
        </div>
      </div>
    </div>
  );
